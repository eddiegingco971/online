              ...
              <div class="col-12">
                ...
                <div class="invoice p-3 mb-3">
                  ...
                  <div class="row no-print">
                    <div class="col-12">
                      <button type="button" wire:loading.remove wire:target="codOrder" class="btn btn-success float-right"><i class="far fa-credit-card"></i> COD</button>
            ...
            <div class="col-md-12">
                <div class="shadow bg-white p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label>Phone Number</label>
                            <input type="number" wire:model.defer="phone_number" id="phone_number" class="form-control" placeholder="Enter Phone Number" />
